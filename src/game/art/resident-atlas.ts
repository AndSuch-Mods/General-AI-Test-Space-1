/** Original layered native artwork. See docs/ART_RESIDENT_V7.md. */
export const RESIDENT_TEXTURE = 'resident-layered-v7';
/** Historical asset only. New character rendering does not load or sample this image. */
