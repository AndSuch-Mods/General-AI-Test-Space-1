...
export const arrival = [
  ...
  { id: 'journal', label: 'Read the household ledger', x: 386, y: 294, scope: 'personal' as Scope,
  ...
  { id: 'bed', label: 'Rest', x: 210, y: 345, scope: 'personal' as Scope,
    title: 'Bed', text: '' },
  { id: 'desk', label: 'Open drawer', x: 382, y: 289, scope: 'personal' as Scope,
    title: 'Writing desk', text: '' },
